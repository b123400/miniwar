...
siuming.prototype = Object.create(Item.prototype);

siuming.prototype.animateSprite = function () {
  var _this = this;
  function animate () {
    if (_this.hp <= 0) return; // if this thing is destroyed, stop
...
siuming.prototype.shouldAttackItem = function (item) {
  return !(item instanceof siuming);
}

siuming.prototype.attack = function (anotherItem) {
  Socket.attackItem(this, anotherItem, 10);
  this.lastAttack = Date.now();
}
